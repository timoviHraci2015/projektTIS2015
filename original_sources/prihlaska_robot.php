			...
			<FORM name="robot_data" onsubmit="return OnSubmitForm();" Method="POST">
				...
				<TABLE class="form">
					<?php
						...
						if ($wim == 1){
							echo "<TR><TD class=\"reddot\"></TD><TD class=\"title\" colspan=\"2\">Súťažná kategória pre rok ".$_SESSION['year'].":</TD><TD class=\"notice\"> ● Povinné údaje</TD>";
							echo "<TR><TD></TD><TD rowspan=\"2\"><i><br/>Jedného robota môžete prihlásiť aj do viacerých kategórií naraz</i></TD><TD class=\"input\">";
							echo "<UL>";
