			...
			////END VELKYCH IF-ov
				...
				if ($wim == 1){
					...
					while ($robot = mysql_fetch_object($sql)) {
						...
						echo "<TD><INPUT Type=\"submit\" display=\"inline\" Name=\"edit\" onclick=\"document.pressed=this.value\" value=\"Edit\"></TD>";
						echo "<TD><INPUT Type=\"submit\" display=\"inline\" Name=\"delete\" onclick=\"document.pressed=this.value\" value=\"Delete\"></TD>";
					...
					//vypis kategorii aktualnej sutaze, ktorej sa chce robot zucastni
						echo "<b>Competition category for the year ".$_SESSION['year'].":</b></TD><TD colspan=\"2\" class=\"notice\"> ● Required entry</TD></TR><TR><TD><UL>";
						...
						echo "</TD><TD><br/><br/><br/><br/><br/><INPUT Type=\"submit\" display=\"inline\" Name=\"catedit\" onclick=\"document.pressed=this.value\" value=\"Set\"></TD></TR>";
					...
					echo "<INPUT Type=\"submit\" name=\"pridaj\" value=\"Add new robot\"></FORM></TD></TR>";
					...
					echo "<INPUT Type=\"submit\" name=\"logged\" value=\"Done\"></TD></TR>";
					echo "</TABLE>";
					//echo "<TD class=\"input\"><INPUT Type=\"submit\"  Name=\"edit\" onclick=\"document.pressed=this.value\" value=\"Edit\">";
					//echo "<INPUT Type=\"submit\"  Name=\"edit\" onclick=\"document.pressed=this.value\" value=\"Delete\"></TD></TR>";
