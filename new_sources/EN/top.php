...
<body>
	<div class="body_bg">
			<div class="menu">
				<div class="lang">
					<a href="index.php?page=news"><img src="images/en.gif" alt="EN"></a>
					...
					<?php
						if (isset($_GET['page'])){
							...
							if ($_GET['page'] == "news" || ($_GET['page'] == "stats")) {
								echo "<li><a class=\"menu_button current\" href=\"index.php?page=news\">News</a></li>";
							} else {
								echo "<li><a class=\"menu_button\" href=\"index.php?page=news\">News</a></li>";
							}
							//pravidla
							if ($_GET['page'] == "rules") {
								echo "<li><a class=\"menu_button current\" href=\"index.php?page=rules\">Rules</a></li>";
							} else {
								echo "<li><a class=\"menu_button\" href=\"index.php?page=rules\">Rules</a></li>";
							}
							//prihlaska
							if ($_GET['page'] == "login" || $_GET['page'] == "login2" || $_GET['page'] == "lor" || $_GET['page'] == "confirm") {
							//pre nelognuteho linkovanie na prihlasit sa! {logme}
								if ($_SESSION['a_id'] == ""){
									echo "<li><a class=\"menu_button current\" href=\"index.php?page=logme\">Register</a></li>";
								} elseif (!empty($_SESSION['a_id'])) {
									echo "<li><a class=\"menu_button current\" href=\"index.php?page=login\">My profile</a></li>";
								}		
							} else {
							//pre nelognuteho linkovanie na prihlasit sa! {logme}
								if ($_SESSION['a_id'] == ""){
									echo "<li><a class=\"menu_button\" href=\"index.php?page=logme\">Register</a></li>";
								} elseif (!empty($_SESSION['a_id'])) {
									echo "<li><a class=\"menu_button\" href=\"index.php?page=login\">My profile</a></li>";
								}	
							}
							//roboty
							if ($_GET['page'] == "robots") {
								echo "<li><a class=\"menu_button current\" href=\"index.php?page=robots\">Robots</a></li>";
							} else {
								echo "<li><a class=\"menu_button\" href=\"index.php?page=robots\">Robots</a></li>";
							}
							//poradna
							if ($_GET['page'] == "advice") {
								echo "<li><a class=\"menu_button current\" href=\"index.php?page=advice\">Help</a></li>";
							} else {
								echo "<li><a class=\"menu_button\" href=\"index.php?page=advice\">Help</a></li>";
							}
							//archiv
							if ($_GET['page'] == "archive") {
								echo "<li><a class=\"menu_button current\" href=\"index.php?page=archive\">Archive</a></li>";
							} else {
								echo "<li><a class=\"menu_button\" href=\"index.php?page=archive\">Archive</a></li>";
							}
							//prihlas ma
							if ($_GET['page'] == "logme") {
								if (!empty($_SESSION['a_id'])) {
									echo "<li><a class=\"menu_button current\" href=\"index.php?page=logout\">Log out</a></li>";
								} elseif ($_SESSION['a_id'] == "") {
									echo "<li><a class=\"menu_button current\" href=\"index.php?page=logme\">Log in</a></li>";
								}	
							} else {
								if (!empty($_SESSION['a_id'])) {
									echo "<li><a class=\"menu_button\" href=\"index.php?page=logout\">Log out</a></li>";
								} elseif ($_SESSION['a_id'] == "") {
									echo "<li><a class=\"menu_button\" href=\"index.php?page=logme\">Log in</a></li>";
								}
							}	
						} else {
							echo "<li><a class=\"menu_button current\" href=\"index.php?page=news\">News</a></li>";
