<?php
	...
	function openMySQL($host, $user, $pass, $db) {
		$link = mysql_connect($host, $user, $pass) or die("Unable to connect to Database: " . mysql_error());
		$dbsel = mysql_select_db($db, $link) or die("Unable to select Database: ". mysql_error());
	...
	function check_mail($email) {
			if (
                            ...
                            // RB: changed to be less strict and allow e.g. '-' character in email address:
	...
	function sendmail($to, $hash, $pass) {
		...
		$subject = "[Istrobot 2013] Account activation";

		//begin of HTML message
		$message = "<html><body>
		Your login mail is <b><u>".$to."</u></b><br />
		Your password is <b><u>".$pass."</u></b><br />
		Click on the list below (or copy&paste into your browser).
        <a href=\"http://www.robotika.sk/contest/2013/EN/activate.php?hash=".$hash."\">http://www.robotika.sk/contest/2013/EN/activate.php?hash=".$hash."</a>
		<br /><br /><hr />
		ISTROBOT
		</body>
		</html>";
